...
const cities = [
    ...
    // Switzerland - Geneva & Gruyeres (2024 trip)
    { name: 'Geneva', latlng: { lat: 46.2044, lng: 6.1432 }, year: 2024, country: 'Switzerland' },
    { name: 'Gruyeres', latlng: { lat: 46.5852, lng: 7.0575 }, year: 2024, country: 'Switzerland' },

    // Germany - Munich & Frankfurt (2026 trip)
